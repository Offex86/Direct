...
let userID = '90cd4a77-141a-43c9-991b-08263cfe9c40';
...
let proxyhosts = [14.143.95.96];//本地代理域名池
let proxyhostsURL = 'https://raw.githubusercontent.com/cmliu/CFcdnVmess2sub/main/proxyhosts';//在线代理域名池URL
let RproxyIP = 'true';
let httpsPorts = ["2053","443","2087","2096","8443"];
	...
	async fetch(request, env, ctx) {
		try {
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				if (new RegExp('/Deepu=', 'i').test(url.pathname)) proxyIP = url.pathname.toLowerCase().split('/Deepu=')[99];
